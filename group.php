...
<div class="form-group col-md-6">
<label>
<b><font color="#ed2618"></font>Group Name : </b>
</label>
<input type="text" id="gnm" name="gnm" class="form-control" value="" style="width:100%" placeholder="Enter Group Name" required>
</div>
...
function show()
{
	$('#show').load("group_list.php").fadeIn('fast');
}
