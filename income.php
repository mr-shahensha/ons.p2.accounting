...
<label>
<b><font color="#ed2618"></font>Income Head : </b>
</label>
<select class="form-control" name="cr" id="cr" required>
...
<div class="form-group col-md-4">
<label>
<b><font color="#ed2618"></font>To : </b>
</label>
<select class="form-control" name="dr" id="dr" required onchange="calbal(this.value)">
  <option value="">*****Select*****</option>
  <?php
...
<input type="hidden" name="page_name" value="income.php">  
...
function show()
{
	$('#show').load("openbal_list.php?type="+1).fadeIn('fast');
}
